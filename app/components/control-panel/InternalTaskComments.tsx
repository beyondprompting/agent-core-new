...
export function InternalTaskComments({ taskId }: { taskId: Id<"tasks"> }) {
  return <div className={`${styles.interactiveControls} flex min-h-0 min-w-0 flex-col [&>aside]:flex-1`}><TaskMediaProvider taskId={taskId}><RequestCommentsSection taskId={taskId} /></TaskMediaProvider></div>;
}
