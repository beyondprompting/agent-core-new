...
export function RequestsBoard({ requests }: { requests: ExternalRequest[] }) {
  ...
  return (
    <div tabIndex={0} role="region" aria-label="Board de tareas por estado" className="overflow-x-auto px-4 pb-10 focus-visible:outline-2 focus-visible:outline-ring sm:px-8">
