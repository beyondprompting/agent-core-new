  ...
  return (
    <div className="flex h-full flex-col">
      <div className="shrink-0 border-b border-border px-4 py-3">
        <Link href="/workspace/requests" className="text-sm font-medium text-primary hover:underline">← Mis solicitudes</Link>
      </div>
      {thread === undefined ? <p role="status" className="p-8 text-muted-foreground">Cargando conversación…</p> : thread === null ? (
        <div role="status" className="p-8">
          ...
          <p className="mt-2 text-sm text-muted-foreground">Esta conversación ya no está disponible. Podés volver al panel para consultar tu solicitud.</p>
        </div>
